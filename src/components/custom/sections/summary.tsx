          ...
          <div className="w-full relative">
            ...
            <div className="relative shadow-xl bg-slate-100 dark:bg-gray-900 border p-6 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start backdrop-blur-xl">
              ...
              <p className="font-normal text-sm lg:text-base text-gray-900 dark:text-slate-200 relative z-50 mt-2">
                ...
                rewards systems and crafting compelling marketing animations, my journey reflects a commitment to excellence and a
                passion for pushing the boundaries of technology. With a Master's in Information Studies underway and a track
                record of contributions in both academic and professional settings, I am poised to thrive in any dynamic software
                engineering role.
              </p>
            </div>
          </div>
